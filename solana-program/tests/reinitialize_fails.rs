//This test ensures:
//The first initialization (SOL or SPL) succeeds
//The second initialization (same initializer + freelancer) fails
//PDA must already be owned by your program
//Program must refuse to overwrite the existing escrow state
//No lamports/token transfers occur on second init
//State must remain unchanged
//This test simulates an attacker or buggy client trying to reuse a PDA.
