            ...
            <div className="flex justify-center mb-4">
              ...
              {!signed && connected && (
                <button
                  ...
                  className="border-2 border-primary-600 hover:border-primary-400 rounded-lg text-primary-600 hover:text-primary-400 w-full px-4 py-2"
                >
              ...
              {signed && connected && (
                <div className="mb-2 flex items-center font-bold text-green-600">
